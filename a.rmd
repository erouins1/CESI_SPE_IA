...
p_comparison <- ggplot(comparison_data, aes(x = Gestational_age)) +
        ...
        scale_colour_manual(values = c("Linear Model" = "blue", "Polynomial Model" = "red", "Polynomial C Model" = "black")) +
        labs(title = "Comparison of Linear and Polynomials Model Predictions",
