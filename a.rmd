...
```
---
Le modèle linéaire et le modèle mixte donnent exactement les mêmes résultats.
Comme facteur aléatoire, nous avons utilisé le groupe, qui indique si l'expérience a été réalisée via infrarouge ou non.
Nous souhaitions connaître si cela pouvait avoir une incidence.
